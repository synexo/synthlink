...
// What was ported
// ---------------
// The receive pulse-shaping/bandpass filter, the AGC formula, the Costas-style
// carrier tracking, the complex T/2 LMS equalizer, the Gardner symbol-
// synchronisation detector, and the multi-stage RX training state machine — all
// reproducing spandsp's behaviour with matching constants and time budgets. The
// bandpass-RRC filter coefficients are in V22RxRRC.js, a derived port likewise.
// Licence and attribution are the header block above.
//
